...
import com.example.rental.services.impl.ProofOfIdentityServiceImpl;
...
public class ProofOfIdentityController {
  ...
  @Autowired
  private ProofOfIdentityServiceImpl proofOfIdentityServiceImpl;

  @PostMapping("/verification")
  public void verificationProofOfIdentity(@RequestParam(name = "clientId") int id, @RequestParam(name = "date") LocalDate localDate) {
    proofOfIdentityServiceImpl.verificationProofOfIdentity(id, localDate);
  }
